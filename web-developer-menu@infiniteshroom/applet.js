...
var CommandConstants = new function() {
  this.COMMAND_START_ALL = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/restart_servers.sh";
  this.COMMAND_STOP_ALL = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/stop_servers.sh";
  this.COMMAND_START_APACHE = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/restart_apache.sh";
  this.COMMAND_STOP_APACHE = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/stop_apache.sh";
  this.COMMAND_START_MYSQL = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/restart_mysql.sh";
  this.COMMAND_STOP_MYSQL = "./.local/share/cinnamon/applets/web-developer-menu@infiniteshroom/stop_mysql.sh";
  this.COMMAND_APACHE_CONFIG_EDIT = "xed admin:///etc/apache2/sites-enabled/000-default";
  this.COMMAND_PHP_CONFIG_EDIT = "xed admin:///etc/php/8.3/apache2/php.ini";
...
MyApplet.prototype = {
  ...
  _init: function(orientation){
    ...
    this.menu.addAction(_("Servers Start"), function(event) {
      Util.spawnCommandLine(CommandConstants.COMMAND_START_ALL);
    });
    this.menu.addAction(_("Servers Stop"), function(event) {
      Util.spawnCommandLine(CommandConstants.COMMAND_STOP_ALL);
    });
